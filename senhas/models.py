...
class Viagem(models.Model):
    ...
    cnpj_empresa_transporte = models.CharField(max_length=18, validators=[validate_CNPJ])
    cadastur_empresa_transporte = models.CharField(max_length=18)
    obs = models.TextField(max_length=2000, verbose_name='Observação', blank=True, null=True)
    estado_origem = models.ForeignKey(Estado, on_delete=models.PROTECT, blank=True, null=True)
...
class Viagem_Turismo(models.Model):
    ...
    viagem = models.OneToOneField(Viagem, on_delete=models.CASCADE, null=True, blank=True)
